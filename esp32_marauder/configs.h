#pragma once
  ...
  #define MARAUDER_VERSION "v1.14.3-op-unified"
  ...
  //#define API_HOTSPOT_SSID "Julius-iPhone"   // Override in api_server.h
  //#define API_HOTSPOT_PASSWORD "changeme"      // Override in api_server.h
  //// END API SERVER
  ...
  #elif defined(BLACKHAT_S3)
    #define HARDWARE_NAME "BlackHat ESP32-S3"
  #else
 ...
 //// BOARD FEATURES
  ...
  //// BLACKHAT LED STUFF
    ...
    #define BHLED_GREEN 4
    #define BHLED_RED   5
    #define BHLED_BLUE  6
  #endif
  //// END BLACKHAT LED STUFF

  //// BLACKHAT OLED STUFF
  #ifdef HAS_BLACKHAT_OLED
    #define BHOLED_SDA  8
    #define BHOLED_SCL  9
    #define BHOLED_ADDR 0x3C
  #endif
  //// END BLACKHAT OLED STUFF
